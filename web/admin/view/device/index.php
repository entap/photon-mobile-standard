		...
		<tr>
			...
			<td>
				<div class="text-center">
					...
					<a href="device.php?action=device_test&id=<?= $record['id'] ?>" class="btn btn-info btn-sm" data-toggle="remote-modal"><span class="glyphicon glyphicon-wrench"></span> 開発端末</a>
				</div>
			</td>
		</tr>
	<?php } ?>
